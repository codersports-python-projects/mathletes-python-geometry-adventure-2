# Mathletes: Python Geometry Adventure 2 - launch_phase_student_skeleton_main.py
...
class MathletesAdventure:
    ...
    def user_setup(self):
        ...
        while True:
            ...
            # Validate age using utility function
    ...
    def load_challenge_module(self):
        ...
        # Call the appropriate function based on the selected challenge
        ...
        # Proceed to evaluate the user's solution
