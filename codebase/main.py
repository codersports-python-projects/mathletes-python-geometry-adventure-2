# Mathletes: Python Geometry Adventure 2 - main.py
...
class MathletesAdventure:
    ...
    def repeat_or_end_adventure(self):
        ...
        choice = input(
            "Would you like to try another challenge? (yes/no): ").strip().lower()
        if choice == 'yes':
            self.select_challenge()
        else:
            self.save_progress()
            print(
                "Thank you for playing Mathletes: Python Geometry Adventure 2! Goodbye!")
